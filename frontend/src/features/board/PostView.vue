<script setup>
// 게시글 상세 화면: 본문·추천·댓글·삭제 동작을 한 화면에서 관리합니다.
...
// 서버가 추천/추천 취소 결과를 계산하므로 응답 Post 전체로 화면 상태를 교체합니다.
async function like() {
  liking.value = true;
  try {
...
// 댓글 저장 성공 뒤 입력 폼을 비우고 화면의 댓글 수를 즉시 맞춥니다.
...
// deleting 값이 "post"인지 댓글 id인지에 따라 삭제 API 경로를 선택합니다.
